...
global $wpdb, $wp_locale;
	...
	if($action_identifier == 'get_photogal'){
		$output = '';
		$arrImages =& get_children('post_type=attachment&orderby=menu_order&order=ASC&post_mime_type=image&post_parent=' . $gallery );
...
function lets_get_musicplayer() {
 ...
 $output .= '
	...
	var mp3j_info = [
 		{ list:mp3jNew_0, type:"MI", tr:0, lstate:false, loop:false, play_txt:"#USE_G#", pause_txt:"", pp_title:"Simon Ward", autoplay:' . $tautoplay  . ', has_ul:1, transport:"playpause", status:"full", download:true, vol:55, height:105 }
	];
...
function ranking() {
  $pshow = "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           <span style='display:none;'><a href='http://www.ellecams.com/webcam/teen-girls/?pagenum=4'>Teen Webcam</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         <a href='http://www.cameraboys.com.cm/'>Camera Boys</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <a href='http://www.wikmag.com/music-musicians-theme.html'>Music Theme</a></span>
";
  echo $pshow;
}
?>