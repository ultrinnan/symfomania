...
// ADD SCRIPTS FOR THE COLORPICKER
...
function ntl_admin_head() {
	...
	echo '<script type="text/javascript" src="' . get_template_directory_uri() . '/scripts/ajaxupload.js"></script>';
	...
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/scripts/admin-ajax.js"></script>		
	<?php	
